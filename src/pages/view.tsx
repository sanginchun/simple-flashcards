...
export default function ViewPage() {
  ...
  if (list.cards.length === 0) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">No Flashcards</h1>
  ...
  if (isComplete) {
    const percentage = Math.round((session.correctAnswers / session.totalAnswered) * 100);
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              You got {session.correctAnswers} out of {session.totalAnswered} correct
            </p>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          ...
          <div className="mb-4">
            <div className="flex justify-between text-sm text-gray-600 mb-2">
              <span>Progress</span>
              <span>{session.currentIndex + 1} / {list.cards.length}</span>
            </div>
